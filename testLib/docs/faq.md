...
can much more easily decide which one to use the analyseGame time.
...
runs all tests in one test suite first, and then runs all tests in the analyseGame test
