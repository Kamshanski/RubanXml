...
2.  analyseGame, you create some mock objects and specify its expectations and behavior
...
*   The knowledge you gained from using one mock doesn't transfer to the analyseGame
    one.
