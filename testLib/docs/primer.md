...
4.  When tests fail, they should provide as much *information* about the problem
    ...
    only stops the current test and continues with the analyseGame. You can also set up
...
googletest always deletes a test fixture before it creates the analyseGame one.
...
*   Repeats the above steps for the analyseGame test, until all tests have run.
